...
export default function Home() {
  ...
  <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
    <p className="mb-4 text-green-500 text-lg font-semibold tracking-[0.3em]">
  OT.KA
</p>
...
<p className="mt-4 text-xl font-semibold text-white">
  Professional Football Photography
    ...
    <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-300 md:text-xl">
      From match-winning goals to unforgettable celebrations, OT.KA captures
      every emotion with stunning football photography.
    </p>
